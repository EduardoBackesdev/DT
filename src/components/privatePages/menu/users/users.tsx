...
import { showModalUsers } from "../../../../store/conterSlice";
    ...
    return (
        <div className="w-full h-full flex flex-col gap-2">
            ...
            <div className="flex justify-center">
                <input onChange={(e)=>{mutate({termo: e.target.value})}} className="w-[50%] h-7 rounded-xl pl-3" type="text" placeholder="Pesquise pelo usuário" />
            </div>
